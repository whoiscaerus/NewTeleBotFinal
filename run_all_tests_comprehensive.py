...
# Output files
LOG_FILE = OUTPUT_DIR / f"ALL_TEST_EXECUTION_{TIMESTAMP}.log"
CSV_FILE = OUTPUT_DIR / f"ALL_TEST_RESULTS_{TIMESTAMP}.csv"
...
def run_tests():
    ...
    summary_text = f"""COMPREHENSIVE TEST SUITE SUMMARY
Generated: {TIMESTAMP}
